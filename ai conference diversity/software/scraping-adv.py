...
def get_speaker(link):
    soup = request(link)

    lst = []
    a = soup.find('div', class_='uv-shortcard__img-wrap')
    print(a)
    for i in soup.findAll('div', class_='uv-shortcard__title'):
        print(i)
        print('1')
...
if __name__ == '__main__':
    ...
    #
    applied_urls = ['https://www.re-work.co/events/applied-ai-virtual-summit']
    ...
    get_speaker('https://www.re-work.co/events/applied-ai-summit-san-francisco-2019/schedule')
